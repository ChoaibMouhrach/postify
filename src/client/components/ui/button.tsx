...
const ButtonCMP = React.forwardRef<HTMLButtonElement, ButtonCMPProps>(
...
ButtonCMP.displayName = "ButtonCMP";

interface ButtonProps extends ButtonCMPProps {
  pending?: boolean;
}

const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ children, pending, disabled, ...rest }, ref) => {
    return (
      <ButtonCMP {...rest} disabled={pending || disabled} ref={ref}>
        {pending ? (
          <>
